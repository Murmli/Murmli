...
// Parse targetLanguages from languageStore in frontend
const languageStorePath = path.join(__dirname, '..', '..', 'frontend', 'src', 'stores', 'languageStore.js');
...
const { languageMapRaw, languageMap } = require("../languageMap.js");
...
const buildLanguages = async () => {
    console.log('Starting incremental translation process for backend...');
